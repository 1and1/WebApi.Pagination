...
msbuild WebApi.Pagination.sln /nologo /t:Rebuild /p:Configuration=%BuildConfiguration%
if errorlevel 1 pause

::Create NuGet packages
mkdir build\%BuildConfiguration%\Packages
nuget pack WebApi.Pagination\WebApi.Pagination.csproj -Properties Configuration=%BuildConfiguration% -Symbols -OutputDirectory build\%BuildConfiguration%\Packages
if errorlevel 1 pause
